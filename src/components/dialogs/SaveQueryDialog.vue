    ...
    <DialogContent class="sm:max-w-[440px]">
      ...
      <div class="py-2 flex flex-col gap-4">
        ...
        <div class="bg-muted/30 border rounded-md px-3 py-2 text-xs font-mono text-foreground/60 max-h-20 overflow-hidden relative">
          ...
          <div class="absolute inset-x-0 bottom-0 h-6 bg-gradient-to-t from-muted/30 to-transparent pointer-events-none" />
        </div>
        ...
        <div class="flex flex-col gap-1.5">
          ...
          <textarea
            ...
            class="w-full rounded-md border border-input bg-transparent px-3 py-2 text-sm placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50 focus-visible:border-ring resize-none"
          />
        </div>
        ...
        <div class="flex flex-col gap-1.5">
          ...
          <select
            ...
            class="h-9 w-full rounded-md border border-input bg-transparent px-3 py-1 text-sm focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50 focus-visible:border-ring"
          >
      ...
      <DialogFooter>
        ...
        <Button @click="save" :disabled="isSaving || !name.trim()" class="min-w-[100px] font-bold">
