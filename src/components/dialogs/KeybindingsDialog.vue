...
<template>
  <Dialog :open="props.open" @update:open="emit('update:open', $event)">
    ...
    >
      ...
      <!-- Keybinding list -->
      <div class="space-y-4 py-1 max-h-[420px] overflow-y-auto pr-1">
              ...
              >
                ...
                <div class="flex items-center gap-1.5 shrink-0 ml-4">
                  ...
                  <template v-if="recording === def.action">
                    <kbd
                      class="inline-flex items-center gap-1 px-2 py-0.5 rounded border border-primary bg-primary/10 text-[11px] font-mono text-primary min-w-[90px] justify-center animate-pulse"
                    >
                  ...
                  <template v-else>
                    <button
                      class="inline-flex items-center gap-1 px-2 py-0.5 rounded border border-input bg-muted/40 text-[11px] font-mono text-foreground min-w-[90px] justify-center hover:border-primary hover:bg-primary/10 hover:text-primary transition-colors cursor-pointer"
